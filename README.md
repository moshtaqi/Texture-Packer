...
```text
MaterialTextureStudio-v1.1.exe
```
...
1. Run `MaterialTextureStudio-v1.1.exe`.
...
7. Click **Export Selected**, **Export All**, or use **Batch Conversion** for nested folders.
8. Use **Open Output** after export to jump to the generated textures.
...
```powershell
python -m PyInstaller --clean --noconfirm --onefile --windowed --name MaterialTextureStudio-v1.1 --icon texture_packer_icon.ico --add-data "material_texture_studio/assets/fonts/Comfortaa.ttf;material_texture_studio/assets/fonts" --add-data "texture_packer_icon.ico;." run_material_texture_studio.py
```
